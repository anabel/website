...
excerpt: Descubre cómo funciona el sensor de las cámaras digitales
...
<image alt="Vista de detalle de un sensor de cámara réflex" />
...
<image alt="Una mano sujeta una lupa que muestra simbólicamente los píxeles de una fotografía de paisaje" />
...
<image alt="capa de filtros y cristales de un sensor" />

El sensor solo almacena la intensidad de luz, no el color, de modo que **cada chip está cubierto por una capa de filtros y cristales**(microlentes) que sirven tanto para enfocar a modo de lupa el haz de luz dentro de cada célula (__píxel__) como para dotarla de __color__ (para más detalles sobre el proceso de estimación de color en las cámaras digitales ver el [mosaico de Bayer](http://es.wikipedia.org/wiki/Mosaico_de_Bayer)).
